...
import semanticweb.uibk.at.eventfulwrapper.utils.OAuthHeader;
import semanticweb.uibk.at.eventfulwrapper.utils.SpecialSymbol;
...
public class OAuthSignature {
    ...
    private static String mapToString(Map<String, String> paramsMap, String keyValueDelimiter, String paramsDelimiter) {
         Stream<Map.Entry<String, String>> stream = paramsMap.entrySet().stream();
        return stream.map(entry -> entry.getKey() + keyValueDelimiter + entry.getValue())
